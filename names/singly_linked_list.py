...
#    Methods:
#    Append - add a new node to the node referenced by the tail
#    Prepend - Add a new node and point that node's next_node at the old head - update head pointer. This new node becomes the head.
#    Remove Head
#    Remove Tail
#    Contains?
#    Get Max?
